...
train_air$Gender <- as.character(train_air$Gender)
train_air$Customer.Type <- as.character(train_air$Customer.Type)
train_air$Type.of.Travel <- as.character(train_air$Type.of.Travel)
train_air$Class <- as.character(train_air$Class)

test_air <- read.csv('test.csv')

test_air$Gender <- as.character(test_air$Gender)
test_air$Customer.Type <- as.character(test_air$Customer.Type)
test_air$Type.of.Travel <- as.character(test_air$Type.of.Travel)
test_air$Class <- as.character(test_air$Class)
...
# 예측 - Inflight.entertainment의 평균점수 4.0점
Bu_bu_te$Inflight.entertainment <- 4
...
# 예측 - inflight.entertainment 4.0점
Pe_eco_te$Inflight.entertainment <- 4.0
...
Pe_eco_te$Inflight.entertainment <- 4.6
